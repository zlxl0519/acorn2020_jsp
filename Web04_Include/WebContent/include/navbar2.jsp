...
if(thisPage.equals("home")){%>
	<div class="navbar navbar-expand-sm navbar-dark bg-primary">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class=" nav-link active" href="${pageContext.request.contextPath }/test6/home.jsp" >Home</a>
			</li>
			<li class="nav-item">
...
<%}else if(thisPage.equals("game")){ %>
	<div class="navbar navbar-expand-sm navbar-dark bg-primary">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link active" href="${pageContext.request.contextPath }/test6/game.jsp" >Game</a>
			</li>
			<li class="nav-item">
				<a class="nav-link " href="${pageContext.request.contextPath }/test6/study.jsp" >Study</a>
			</li>
...
<%}else if(thisPage.equals("study")){ %>
	<div class="navbar navbar-expand-sm navbar-dark bg-primary">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link active" href="${pageContext.request.contextPath }/test6/study.jsp" >Study</a>
			</li>
		</ul>
	</div>
<%} %>
