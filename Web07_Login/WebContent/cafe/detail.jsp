...
<body>
<div class="container">
	<%if(dto.getPrevNum() !=0){ //select 문에 이전글이 없을때는 디폴트값을 0 이라고 했기때문에 0이 아닐때만 나오도록한다. %>
		<a class="btn btn-outline-info"  href="detail.jsp?num=<%=dto.getPrevNum() %>">
	...
	<%} %>
	<%if(dto.getNextNum() !=0){ %>
		<a class="btn btn-outline-info" href="detail.jsp?num=<%=dto.getNextNum() %>">
	...
	<%if(dto.getWriter().equals(id)){ %>
		...
		<a class="btn btn-outline-danger btn-sm" href="private/delete.jsp?num=<%=dto.getNum() %>">
