...
<script>
	...
	$("#getBtn").on("click", function(){
		//jquery 의 기능을 이용해서 ajax 요청하기 // $를 오브젝트로 보고 $에 ajax()라는 기능을 쓰는것
		$.ajax({//오브젝트 형식 key:value
			//요청 방식
			method:"GET",
			//요청 경로
			...
			//서버가 응답할 문자열은 인자로 들어온다. //응답한 데이터를 활용할지는 {} 안에서 결정
			success:function(responseData){//성공적으로 응답받았을때 실행되는 곳
