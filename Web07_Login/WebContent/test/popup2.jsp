...
<script>
	...
	*/
	...
	//팝업 띄우는 함수 
	function showPopup(){//폭, 넓이, 위치
		window.open("popup_page2.jsp","팝업창","width=400,height=300,top=100,left=100");
	}
	
	//팝업을 중앙에 띄우는 함수 
	function showPopup2(){
		PopupCenter("popup_page2.jsp","팝업창", 800, 500);//800,500은 width, height
	}
	...
	<%
		//팝업창을 띄울지 여부 // 몇분동안 안띄우기 체크하면 canPopup 쿠키에 키값으로 저장해놓고 이게 있으면 팝업이 안뜨게 한다.
