...
<script>
	...
	var currentPage=1; //바닥까지 스크롤됬을때 이게 증가한다.
	...
	$(window).on("scroll", function(){
		...
		if(isBottom){//만일 바닥까지 스크롤 했다면...
			...
			$.ajax({
				url:"ajax_list.jsp",
				method:"get",
				data:{pageNum:currentPage}, //ajax_list.jsp?pageNum= currentPage
				seccess:function(data){
					//data 가 html 마크업 형태의 문자열 //class container에 data를 html 마크업으로 추가한다.
					$(".container").html(data);
				}
			});
		}
